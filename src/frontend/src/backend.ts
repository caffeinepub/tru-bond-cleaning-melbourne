...
import type { Id as _Id, ServiceType as _ServiceType, Simplified as _Simplified, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getAllSubmissions(): Promise<Array<Simplified>> {
    ...
    async getSubmissionById(arg0: Id): Promise<Simplified> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubmissionById(arg0);
                return from_candid_Simplified_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitContact(arg0: string, arg1: string, arg2: string, arg3: ServiceType, arg4: string): Promise<Id> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContact(arg0, arg1, arg2, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Simplified_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Simplified): Simplified {
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "windowCleaning" in value ? ServiceType.windowCleaning : "other" in value ? ServiceType.other : "endOfLease" in value ? ServiceType.endOfLease : "pestControl" in value ? ServiceType.pestControl : "carpetCleaning" in value ? ServiceType.carpetCleaning : value;
}
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Simplified>): Array<Simplified> {
    return value.map((x)=>from_candid_Simplified_n2(_uploadFile, _downloadFile, x));
}
